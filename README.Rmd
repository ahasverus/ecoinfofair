...
Launch the [`make.R`](https://github.com/ahasverus/ecoinfofair/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/ahasverus/ecoinfofair/blob/main/CONTRIBUTING.md).
